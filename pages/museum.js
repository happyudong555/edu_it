                    ...
                    <div className="row">
                        <div className="main_background col-md-12">
                            <div className="container">
                                <h4 className="page-header top_location_heading" style={{position: 'absolute'}}>top museum of bangkok</h4>
                                <br/>
                                <input onChange={this.onChange.bind(this)} className="form-control searchBox" placeholder="Search | Find museum"/>
                            </div>
                        </div>
                    </div>
                </div>

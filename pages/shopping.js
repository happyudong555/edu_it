...
export default class Shopping extends React.Component {
    ...
    render() {
        let filter_trips = trips.filter(
            (trips) => {
               if (trips.category === 'shopping mall') {
        ...
        return (
                    ...
                    <div className="row">
                        <div className="main_background col-md-12">
                            <div className="container">
                                <h4 className="page-header top_location_heading" style={{position: 'absolute'}}>shopping mall / market</h4>
                                <br/>
                                <input onChange={this.onChange.bind(this)} className="form-control searchBox" 
                                placeholder="Search | Find Shopping Mall"/>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <style>{`
                ...
                .main_background {
                    ...
                    height: 250px;
                    background-image:url(../static/asset/background/photo-1508928429965-556f16369c42.jpeg);

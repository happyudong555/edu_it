        ...
        return (
                    ...
                    <div className="row">
                        <div className="main_background col-md-12">
                            <div className="container">
                                <h4 className="page-header top_location_heading" style={{position: 'absolute'}}>top temple</h4>
                                <br/>
                                <input onChange={this.onChange.bind(this)} className="form-control searchBox" placeholder="Search | Find Temple"/>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <style>{`
                ...
                .main_background {
                    ...
                    height: 250px;
                    background-image:url(../static/asset/background/photo-1493221875746-1203de4f7a56.jpeg);
                ...
                .main_background::before {
                    ...
                    bottom: 0;
                    left: 0;
                    background-image: linear-gradient(to bottom right,#734932,#bd9f44);
                }
                .grid {
                    height:100%;
